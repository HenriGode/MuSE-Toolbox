...
tmux send-keys -t $SESSION:0 "cd $PROJECT_DIR && /home/henrig/.conda/envs/j3/bin/python scripts/main.py experiment=J3_pra_anf dataset=pra_anf_circ_8ch trainer.devices=[0] model/feature_extractor=pure_stft model/channel_combinator=self_attention model/source_count_estimator=transformer" C-m
...
tmux send-keys -t $SESSION:4 "cd $PROJECT_DIR && /home/henrig/.conda/envs/j3/bin/python scripts/main.py experiment=J3_pra_anf dataset=pra_anf_circ_8ch trainer.devices=[1] model/feature_extractor=wgmsc model/channel_combinator=self_attention model/source_count_estimator=transformer" C-m

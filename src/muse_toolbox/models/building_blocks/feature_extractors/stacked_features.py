...
class StackedFeatureExtractor(BaseFeatureExtractor):
    ...
    def __init__(self, transform: STFTtransform, extractors: list[dict]):

        super().__init__(transform=transform)

        # Import here to avoid circular dependency issues at module level
        import muse_toolbox.models.building_blocks.feature_extractors as fe
